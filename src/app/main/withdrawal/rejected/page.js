...
export default function Rejected(props) {
    ...
    const init = async (dtF, dtT)=>{
        ...
        try{           
            ...
            const ret =  await callApi("/payout/get-rejected", "POST", params) 
            if (ret.status==200){                
                setpending(ret.data)
    ...
    const columns = [       
        ...
        {
            name: "Date Rejected ",
            selector:  row => moment(row.process_date).format("MMM-DD-YYYY hh:mm A"),
            sortable: true,
            width: "230px",                   
        },
    ...
    return (
        <div className="mt-4 px-2">            
           <div className="md:flex justify-between">
            ...
            <View showView={showView} setshowView={setshowView} request={request} type={2}/>
