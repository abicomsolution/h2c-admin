...
function View(props) {
    ...
    return(
        <Modal show={showView}  onClose={handleClose} size="3xl" className={`${interFont.className}`} >            
            {content}           
            <Confirm showConfirm={showConfirm} setshowConfirm={setshowConfirm} onYes={handleYes} ptype={ptype} interFont={interFont}/>
